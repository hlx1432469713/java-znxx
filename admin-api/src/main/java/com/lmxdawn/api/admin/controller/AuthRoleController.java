...
import com.lmxdawn.api.admin.bean.AuthPermission;
...
import com.lmxdawn.api.admin.service.AuthPermissionRuleService;
import com.lmxdawn.api.admin.service.AuthPermissionService;
...
public class AuthRoleController {
     ...
     * 角色列表
     */
    @AuthRuleAnnotation("admin/bean/role/index")
     ...
     * @return
     */
    @AuthRuleAnnotation("admin/bean/role/authList")
    ...
    @AuthRuleAnnotation("admin/bean/role/bean")
     ...
     * @return
     */
    @AuthRuleAnnotation("admin/bean/role/save")
     ...
     * @return
     */
    @AuthRuleAnnotation("admin/bean/role/edit")
     ...
     * @return
     */
    @AuthRuleAnnotation("admin/bean/role/delete")
