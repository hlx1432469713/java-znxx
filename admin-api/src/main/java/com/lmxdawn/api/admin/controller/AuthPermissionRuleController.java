...
public class AuthPermissionRuleController {
     ...
     * @return
     */
    @AuthRuleAnnotation("admin/bean/permission_rule/index")
     ...
     * @return
     */
    @AuthRuleAnnotation("admin/bean/permission_rule/save")
     ...
     * @return
     */
    @AuthRuleAnnotation("admin/bean/permission_rule/edit")
     ...
     * @return
     */
    @AuthRuleAnnotation("admin/bean/permission_rule/delete")
